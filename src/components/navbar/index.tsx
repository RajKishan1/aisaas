  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-3 p-6 fixed top-0 left-0 right-0 z-50">
      <div className="flex items-center gap-4">
        ...
        {!hasCanvas ||
          (!hasStyleGuide && (
            <div className="lg:inline-block hidden rounded-full text-primary/60 border border-white/10 backdrop-blur-xl bg-white/5 px-4 py-2 text-sm saturate-150">
              Project
            </div>
          ))}
      </div>
      ...
      <div className="flex items-center gap-4 justify-end">
        ...
        <Button
          variant="secondary"
          className="rounded-full h-12 w-12 flex items-center justify-center backdrop-blur-xl bg-white/[0.08] border
hover:bg-white/[0.12]
